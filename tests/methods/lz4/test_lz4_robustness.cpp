/**
 * @file test_lz4_robustness.cpp
 *
 * Robustness tests for LZ4 encoder/decoder in the Ghoti.io Compress library.
 *
...
class Lz4RobustnessTest : public ::testing::Test {
protected:
  void SetUp() override {
...
TEST_F(Lz4RobustnessTest, EncoderFinishBeforeUpdate) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
...
TEST_F(Lz4RobustnessTest, EncoderUpdateAfterFinish) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
      gcomp_encoder_create(registry_, "lz4", nullptr, &encoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, EncoderMultipleFinishCalls) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
      gcomp_encoder_create(registry_, "lz4", nullptr, &encoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, EncoderDestroyWithoutFinish) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
      gcomp_encoder_create(registry_, "lz4", nullptr, &encoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, EncoderUpdateZeroSizeInput) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
      gcomp_encoder_create(registry_, "lz4", nullptr, &encoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, EncoderUpdateZeroSizeOutput) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
      gcomp_encoder_create(registry_, "lz4", nullptr, &encoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, EncoderResetMidStream) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
      gcomp_encoder_create(registry_, "lz4", nullptr, &encoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, DecoderFinishBeforeUpdate) {
...
TEST_F(Lz4RobustnessTest, DecoderUpdateAfterFinish) {
  gcomp_decoder_t * decoder = nullptr;
  ASSERT_EQ(
      gcomp_decoder_create(registry_, "lz4", nullptr, &decoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, DecoderMultipleFinishCalls) {
  gcomp_decoder_t * decoder = nullptr;
  ASSERT_EQ(
      gcomp_decoder_create(registry_, "lz4", nullptr, &decoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, DecoderDestroyWithoutFinish) {
  gcomp_decoder_t * decoder = nullptr;
  ASSERT_EQ(
      gcomp_decoder_create(registry_, "lz4", nullptr, &decoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, DecoderUpdateZeroSizeInput) {
  gcomp_decoder_t * decoder = nullptr;
  ASSERT_EQ(
      gcomp_decoder_create(registry_, "lz4", nullptr, &decoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, DecoderUpdateZeroSizeOutput) {
  gcomp_decoder_t * decoder = nullptr;
  ASSERT_EQ(
      gcomp_decoder_create(registry_, "lz4", nullptr, &decoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, DecoderResetMidStream) {
  gcomp_decoder_t * decoder = nullptr;
  ASSERT_EQ(
      gcomp_decoder_create(registry_, "lz4", nullptr, &decoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, EncoderDestroyImmediately) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
      gcomp_encoder_create(registry_, "lz4", nullptr, &encoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, DecoderDestroyImmediately) {
  gcomp_decoder_t * decoder = nullptr;
  ASSERT_EQ(
      gcomp_decoder_create(registry_, "lz4", nullptr, &decoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, EncoderRepeatedReset) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
      gcomp_encoder_create(registry_, "lz4", nullptr, &encoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, DecoderRepeatedReset) {
  gcomp_decoder_t * decoder = nullptr;
  ASSERT_EQ(
      gcomp_decoder_create(registry_, "lz4", nullptr, &decoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, EncoderManySmallUpdates) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
      gcomp_encoder_create(registry_, "lz4", nullptr, &encoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, DecoderManySmallOutputBuffers) {
  gcomp_decoder_t * decoder = nullptr;
  ASSERT_EQ(
      gcomp_decoder_create(registry_, "lz4", nullptr, &decoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, AlternatingUpdateAndReset) {
  gcomp_encoder_t * encoder = nullptr;
  ASSERT_EQ(
      gcomp_encoder_create(registry_, "lz4", nullptr, &encoder), GCOMP_OK);
...
TEST_F(Lz4RobustnessTest, DecoderAlternatingUpdateAndReset) {
  gcomp_decoder_t * decoder = nullptr;
  ASSERT_EQ(
      gcomp_decoder_create(registry_, "lz4", nullptr, &decoder), GCOMP_OK);
